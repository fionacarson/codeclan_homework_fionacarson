...
Hmmm the website says p-value > 0.05 means distribution of data is not signficantly different from normal distribution. 
Our data gives a tiny p-value which suggests the data is very different from a normal distribution. This is in contrary to what we found above. 
